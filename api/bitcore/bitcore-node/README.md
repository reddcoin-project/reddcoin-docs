...
- [REST API parameters and example responses](api-documentation.md)

- [Websockets API namespaces, event names and parameters](sockets-api.md)

- [Testing Bitcore-node in RegTest](wallet-guide.md)
