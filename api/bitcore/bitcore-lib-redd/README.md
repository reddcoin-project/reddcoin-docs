---
title: Bitcore JavaScript Library for Reddcoin
---
...
- [Acknowledging and Requesting Payments: Reddcoin URIs](uri.md)
- [The Transaction Class](transaction.md)
- [Unspent Transaction Output Class](unspentoutput.md)
...
- [Generate a random address](examples.md#generate-a-random-address)
- [Generate a address from a SHA256 hash](examples.md#generate-a-address-from-a-sha256-hash)
- [Import an address via WIF](examples.md#import-an-address-via-wif)
- [Create a Transaction](examples.md#create-a-transaction)
- [Sign a Reddcoin message](examples.md#sign-a-reddcoin-message)
- [Verify a Reddcoin message](examples.md#verify-a-reddcoin-message)
- [Create an OP RETURN transaction](examples.md#create-an-op-return-transaction)
- [Create a 2-of-3 multisig P2SH address](examples.md#create-a-2-of-3-multisig-p2sh-address)
- [Spend from a 2-of-2 multisig P2SH address](examples.md#spend-from-a-2-of-2-multisig-p2sh-address)
