---
title: Bitcore P2P for Reddcoin
---
...
In order to connect to the Reddcoin network, you'll need to know the IP address of at least one node of the network, or use [Pool](pool.md) to discover peers using a DNS seed.
...
Take a look at this [guide](peer.md) on the usage of the `Peer` class.
