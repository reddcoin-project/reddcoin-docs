...
There are many examples of how to use it on the developer guide [section for mnemonic](docs.md). For example, the following code would generate a new random mnemonic code and convert it to a `HDPrivateKey`.
