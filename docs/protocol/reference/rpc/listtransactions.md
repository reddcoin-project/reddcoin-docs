...
[                                        (json array)
  {                                      (json object)
    ...
    "address" : "str",                   (string) The reddcoin address of the transaction.
    ...
    "amount" : n,                        (numeric) The amount in RDD. This is negative for the 'send' category, and is positive
...
```
curl --user myusername --data-binary '{"jsonrpc": "1.0", "id": "curltest", "method": "listtransactions", "params": ["*", 20, 100]}' -H 'content-type: text/plain;' http://127.0.0.1:45443/
```
