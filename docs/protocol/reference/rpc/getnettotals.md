...
```shell
reddcoin-cli getnettotals
curl --user myusername --data-binary '`{"jsonrpc": "1.0", "id": "curltest", "method": "getnettotals", "params": []}`' -H 'content-type: text/plain;' http://127.0.0.1:45443/
```
