...
{                                                    (json object)
  ...
  "relayfee" : n,                                    (numeric) minimum relay fee rate for transactions in RDD/kvB
  "incrementalfee" : n,                              (numeric) minimum fee rate increment for mempool limiting or BIP 125 replacement in RDD/kvB
