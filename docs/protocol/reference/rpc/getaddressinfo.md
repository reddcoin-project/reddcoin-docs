...
The reddcoin address for which to get information.
...
```shell
reddcoin-cli getaddressinfo "bc1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl"
curl --user myusername --data-binary '`{"jsonrpc": "1.0", "id": "curltest", "method": "getaddressinfo", "params": ["bc1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl"]}`' -H 'content-type: text/plain;' http://127.0.0.1:45443/
```
