...
```
{
  ...
  "changeAddress": "hex",        (string, optional, default=pool address) The reddcoin address to receive the change
  ...
  "feeRate": amount,             (numeric or string, optional, default=not set, fall back to wallet fee estimation) Specify a fee rate in RDD/kvB.
...
{                     (json object)
  ...
  "fee" : n,          (numeric) Fee in RDD the resulting transaction pays
