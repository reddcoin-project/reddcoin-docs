...
```shell
reddcoin-cli unloadwallet wallet_name
curl --user myusername --data-binary '`{"jsonrpc": "1.0", "id": "curltest", "method": "unloadwallet", "params": [wallet_name]}`' -H 'content-type: text/plain;' http://127.0.0.1:45443/
```
