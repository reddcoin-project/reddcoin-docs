...
{                             (json object)
  ...
  "vout" : [                  (json array)
    {                         (json object)
      "value" : n,            (numeric) The value in RDD
      "n" : n,                (numeric) index
...
```
reddcoin-cli decoderawtransaction "hexstring"
```

```
curl --user myusername --data-binary '{"jsonrpc": "1.0", "id": "curltest", "method": "decoderawtransaction", "params": ["hexstring"]}' -H 'content-type: text/plain;' http://127.0.0.1:45443/
```
