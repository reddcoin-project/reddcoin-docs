...
```
{
  ...
  "changeAddress": "str",        (string, optional, default=pool address) The reddcoin address to receive the change
...
```
reddcoin-cli signrawtransactionwithwallet "fundedtransactionhex"
```

Send the transaction:

```
reddcoin-cli sendrawtransaction "signedtransactionhex"
```
